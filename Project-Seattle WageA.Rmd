...
1) What are the best paying occupations in Seattle as of June 2024?

2) Is there a statistically significant difference in the proportion of high earners (those earning above the median hourly rate) between information technology professionals and strategic advisors within the Information Technology department in the City of Seattle as of June 2024?
...
How the data was collected: The data was collected by the government (Seattle Department of Human Resources).
...
Sample Size and Distribution: A smaller sample size for strategic advisors compared to information technology professionals could affect the accuracy of the tests.
...
### Part 1: Wage Analysis by Department 
...
Examples of information technology professionals: Computer Programmer, Software Engineer, Computer Systems Analyst, Computer Network Architect.
...
Agresti-Coull CI for Information Technology Professionals: 0.45 0.54.

Agresti-Coull CI for Strategic Advisors: 0.73 0.90

#### Interpretation and Discussion

The Agresti-Coull confidence interval for the proportion of high earners for Information Technology Professionals is [0.45,0.54]. This means we are 95% confident that the true proportion of high earners in the Information Technology Professionals group lies within this range. The Agresti-Coull confidence interval for the proportion of high earners for Strategic Advisors is [0.73,0.90]. This indicates that we are 95% confident that the true proportion of high earners among Strategic Advisors falls within this interval.

Since the proportion of high earners for Information Technology Professionals is relatively moderate compared with the confidence interval for Strategic Advisors, we can believe a greater proportion of high earners in the latter.

### Part 4: Hypothesis Testing 2
...
Homogeneity: The variance in hourly rates within the Strategic Advisors group is similar to the variance in hourly rates within the Information Technology Professionals group.
  
**Hypothesis Testing**

Null Hypothesis (H0): The mean hourly rate for Strategic Advisors is equal to or less than that for Information Technology Professionals.
   
Alternative Hypothesis (H1): The mean hourly rate for Strategic Advisors is higher than that for Information Technology Professionals.
...
Since the p-value (2.877e-05) is significantly less than 0.05, we can reject the null hypothesis. This result provides strong evidence that the mean hourly rate for Strategic Advisors is statistically higher than the mean hourly rate for Information Technology Professionals.


## Summary

In the city of Seattle, employees in the department of Information Technology earn the highest salary, followed by the Police Department. Among all the positions in the department of Information Technology, informational technology professionals and strategic advisors have the most lubricative wage. Though informational technology professionals have the higher mean wage, strategic advisors have the higher proportion of high earners. 
